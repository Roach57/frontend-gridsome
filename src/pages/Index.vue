    ...
    <Layout>
            <el-card shadow="never" style="min-height: 400px" v-if="$page.postsBlogs.edges[0].node.id">
                ...
                <div style="font-size: 0.9rem;line-height: 1.5;color: #606c71;">
                    发布 {{$page.postsBlogs.edges[0].node.created_at}}
                    <br> 更新 {{$page.postsBlogs.edges[0].node.updated_at}}
                </div>
                ...
                <div v-html="$page.postsBlogs.edges[0].node.content" class="markdown-body" style="padding-top: 20px"></div>
            </el-card>
